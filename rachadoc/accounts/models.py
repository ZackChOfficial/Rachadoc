...
class User(AbstractUser):
    ...
    phone_number = models.CharField(_("numéro de téléphone"))
    cnie = models.CharField(_("carte nationale d'identité électronique"))
    date_of_birth = models.DateField(_("date de naissance"),)
    gender = models.CharField(_("date de naissance"), choices=GENDERS)
